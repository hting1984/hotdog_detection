...
#ifndef TENSORFLOW_LITE_MICRO_EXAMPLES_INT_HOTDOG_IMAGE_DATA_H_
#define TENSORFLOW_LITE_MICRO_EXAMPLES_INT_HOTDOG_IMAGE_DATA_H_

#include <cstdint>

extern const int g_hotdog_data_size;
extern const uint8_t g_int_hotdog_data[];
